...
const external = ["@nestjs/common", "@nestjs/cache-manager", "@nestjs/event-emitter", "@aws-sdk/client-ssm", "@nestjs/common", "@nestjs/typeorm", "typeorm", "@elsikora/nestjs-crud-automator"];
