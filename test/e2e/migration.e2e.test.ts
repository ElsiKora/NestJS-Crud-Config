...
describe("Migration E2E Tests", () => {
 ...
 describe("Migration Runner Service Unit Tests", () => {
  it("should not run migrations when disabled", () => {
   ...
   const runnerService = new ConfigMigrationRunnerService(mockMigrationService, options);
  ...
  it("should handle missing migration service gracefully", () => {
   expect(() => {
    const runnerService = new ConfigMigrationRunnerService(undefined as any, {
    ...
    providers: [
     ...
     },
     {
      ...
      useFactory: (
       ...
       configService: CrudConfigService,
      ) => {
       const mockService = {
 ...
 describe("Error Handling Tests", () => {
  it("should handle service initialization errors", async () => {
   ...
   await expect(mockMigrationService.onModuleInit()).rejects.toThrow("Initialization failed");
  });
