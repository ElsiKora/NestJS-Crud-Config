...
import { createDynamicSectionController, createDynamicDataController } from "./controller.factory";
...
@Global()
@Module({})
export class CrudConfigFullDynamicModule implements OnModuleInit {
	...
	public static register(options: ICrudConfigProperties): DynamicModule {
		...
		return {
			...
			imports,
			module: CrudConfigFullDynamicModule,
